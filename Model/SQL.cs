...
namespace OfflineBacklogManager.Model
{
    public class SQL
    {
        ...
        public void AddNewGame(Game input)
        {
            ...
            {
                string CmdStr = "insert into obm_list (title, gamesystem, ownership, status, achivement, achievement_max, progress, playing, wishlist, appid) VALUES (@GTITLE, @GSYSTEM, @GOWNER, @GSTATUS, @GACH, @GACHMAX, @GPROG, @GPLAYING, @GWISH, @GAPPID)";
                ...
                cmd.Parameters.AddWithValue("@GPLAY", input.playing);
